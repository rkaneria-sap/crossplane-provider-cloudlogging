...
sed -i.bak "s/crossplane-provider-cloudlogging/provider-${ProviderNameLower}/g" go.mod
...
git mv "cluster/images/crossplane-provider-cloudlogging" "cluster/images/provider-${ProviderNameLower}"
git mv "cluster/images/crossplane-provider-cloudlogging-controller" "cluster/images/provider-${ProviderNameLower}-controller"
